...
related: [core:engine-rs, workflows-index, nodes-index]
---
...
| **[nodes/](nodes/index.md)** | **"What's already built, and can I reuse it."** The Node/Molecule Library — every reusable Node grouped by purpose, every proven or near-duplicate Node sequence, and a gaps registry — check before writing a new Node |
